...
data_num = [4540,1100,4660, 800, 270, 2760, 1100, 1100, 4070, 1590,1200];
image_dims = [376, 376, 376, 375, 370, 370, 370 ,370, 370, 370, 370;
              1241, 1241, 1241, 1242, 1226, 1226, 1226, 1226, 1226, 1226, 1226];
data_selection = [1,1,1,0,0,0,0,0,1,1,0];

left_focal_length = zeros(1,11);
right_focal_length = zeros(1,11);
left_c0 = zeros(1,11);
left_c1 = zeros(1,11);
right_c0 = zeros(1,11);
right_c1 = zeros(1,11);
base_line = zeros(1,11);
