...
#        values = [args.learning_rate, args.learning_rate, args.learning_rate]
                ...
                with tf.device('/gpu:%d' % i):
                    ...
                    if args.prev_checkpoint_path != '':
                        ...
                        if args.train_mode == 'mapping':
                            ...
                            train_vars = tf.get_collection(tf.GraphKeys.GLOBAL_VARIABLES, scope='slam_model') + tf.get_collection(tf.GraphKeys.GLOBAL_VARIABLES, scope='depth_var_decoder_model2') + tf.get_collection(tf.GraphKeys.GLOBAL_VARIABLES, scope='pose_var_decoder_model')
        ...
        if args.prev_checkpoint_path != '':
            if args.train_mode == 'mapping':
                ...
                load_vars = tf.get_collection(tf.GraphKeys.GLOBAL_VARIABLES, scope='pose_encoder_model') + tf.get_collection(tf.GraphKeys.GLOBAL_VARIABLES, scope='pose_decoder_model') + tf.get_collection(tf.GraphKeys.GLOBAL_VARIABLES, scope='depth_encoder_model') + tf.get_collection(tf.GraphKeys.GLOBAL_VARIABLES, scope='depth_decoder_model') + tf.get_collection(tf.GraphKeys.GLOBAL_VARIABLES, scope='depth_var_decoder_model')  
