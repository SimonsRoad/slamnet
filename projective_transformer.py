...
def projective_transformer(input_images, f0, f1, c0, c1, depthmap, rotation, translation, wrap_mode='border', name='projective_transformer', **kwargs):
    ...
    def _transform(input_images, depthmap, rotation, translation, f0, f1, c0, c1):
        with tf.variable_scope('transform'):
            ...
            images = _transform_with_Rt(input_images, R_mat, t_mat, xyz, f0, c0, f1, c1)
            ...
            images_x = _transform_with_Rt(input_images, R_mat, t_mat, xyz, f0, c0, f1, c1)
            ...
            images_y = _transform_with_Rt(input_images, R_mat, t_mat, xyz, f0, c0, f1, c1)
            ...
            images_roll = _transform_with_Rt(input_images, R_mat, t_mat, xyz, f0, c0, f1, c1)
            ...
            images_pitch = _transform_with_Rt(input_images, R_mat, t_mat, xyz, f0, c0, f1, c1)
    ...
    def _transform_with_Rt(imgs, R,t,pts,f0,c0,f1,c1):
        ...
        xyz_transformed = tf.add(tf.matmul(R,pts),t)
